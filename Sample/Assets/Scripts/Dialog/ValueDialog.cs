...
public class ValueDialog : IDialog
{
    ...
    private readonly Action<string> _onPositiveButtonClicked;
    ...
    public ValueDialog(
        ...
        Action<string> onPositiveButtonClicked = null,
                ...
                return new List<UILayoutElement>()
                {
                    ...
                    UILayoutElement.Create(
                            UIButton.Create(hl)
                                ...
                                .SetOnClickListener(() => { _onPositiveButtonClicked(_valueInputField.Text); })
                                .gameObject
                        )
                        .SetFlexibleWidth(1)
                };
